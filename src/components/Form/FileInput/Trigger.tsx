...
export function Trigger() {
  ...
  return (
    <label
      htmlFor={id}
      className="hover:bg-violet-25 group flex flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-300 px-6 py-4 text-center text-zinc-500 hover:border-violet-300 hover:text-violet-500"
    >
      Selecionar arquivo
